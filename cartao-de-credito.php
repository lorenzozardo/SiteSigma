...
<h1 style="text-align: center; padding-top: 20px; font-size: 45px; font-weight: bold;">Cartão de Crédito</h1>
...
<div class="cartao">
    <form class="form-contato" action="./cartao-de-credito.php" method="post">
